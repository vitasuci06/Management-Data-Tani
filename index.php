            ...
            <div class="col-md-6 mb-3">
                <div class="kpi-card">
                    ...
                    <div class="kpi-content">
                        ...
                        <div class="kpi-row">
                            <h2><?= $totalAnggota ?></h2>
                            <a href="anggota.php" class="kpi-btn purple">
            ...
            <div class="col-md-6 mb-3">
                <div class="kpi-card">
                    ...
                    <div class="kpi-content">
                        ...
                        <div class="kpi-row">
                            <h2><?= $totalPengurus ?></h2>
                            <a href="pengurus.php" class="kpi-btn green">
                                Lihat Data <i class="bi bi-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="kpi-card">
                    ...
                    <div class="kpi-content">
                        ...
                        <div class="kpi-row">
                            ...
                            <a href="bantuan.php?jenis=2" class="kpi-btn yellow">
                                Lihat Data <i class="bi bi-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="kpi-card">
                    ...
                    <div class="kpi-content">
                        ...
                        <div class="kpi-row">
                            ...
                            <a href="bantuan.php?jenis=1" class="kpi-btn orange">
                                Lihat Data <i class="bi bi-arrow-right"></i>
                            </a>
                        </div>
                    </div>
